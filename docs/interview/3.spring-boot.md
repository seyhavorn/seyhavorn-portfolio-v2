...
## Interview Checklist
- [x] Know constructor injection is preferred
- [x] Understand @Transactional self-invocation pitfall
- [x] Can explain JWT stateless flow
- [x] Know Expand-Contract migration pattern
- [x] Understand CAP theorem (consistency > availability for banking)
- [x] Can code a simple @RestControllerAdvice
- [x] Know when to @Cacheable (user profiles yes, balances no)
- [x] Understand Spring profiles for multi-environment config
- [x] Can compare Laravel vs Spring Boot (when asked)
- [x] Know why banks use Spring Boot not Laravel