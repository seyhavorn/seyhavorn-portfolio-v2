...
export const cvData = {
  ...
  stack: [
    "Spring Boot", "Angular", "Vue.js", "Laravel", "NestJS",
    "Docker", "K8s", "Redis", "PostgreSQL", "MySQL",
    "GitHub CI", "AWS", "Spring AI", "Ollama", "GraphQL"
  ],
  education: {
  ...
  projects: [
    {
      ...
      description: "A robust microservices-based integration platform for synchronizing agricultural data entities (commodities, markets, metrics) across nationwide systems. Features duplicate-sync protection, automated Spring Batch jobs, and robust APIs.",
      techStack: ["Spring Boot", "Microservices", "PostgreSQL", "Docker", "Spring Batch"],
      link: "https://github.com/seyhavorn",
      type: "Enterprise Backend"
    },
    {
      title: "Annual Climate Review Portal",
      description: "An interactive dashboard for visualizing annual climate data, including flood mappings and agricultural impacts. Built with complex dynamic Vue filters for province and spatial selection.",
    ...
    },
    {
      ...
      description: "A high-performance secure API for cross-department data sharing. Implemented inline secret-header authentication, date-range filtering, and complex SQL data structuring.",
    ...
    },
    {
      ...
      description: "An intelligent Q&A assistant built on RAG architecture using Spring AI and Ollama. Indexes internal documents and answers contextual queries with local LLM models, supporting speech and image generation.",
      techStack: ["Spring AI", "RAG", "Ollama", "OpenAI", "PostgreSQL (pgvector)"],
      link: "https://github.com/seyhavorn",
      type: "AI / LLM"
    }
  ],
  services: [
    {
      ...
      description: "Designing scalable, fault-tolerant backend systems using Spring Boot and Laravel. I build APIs that are secure, fast, and structured for modern demands.",
      icon: "server"
    },
    {
      title: "AI & LLM Integration",
      description: "Building intelligent systems with RAG pipelines, Spring AI, Ollama, and OpenAI — including speech generation, image generation, and MCP-based tool orchestration.",
      icon: "cpu"
    },
    {
      title: "Full Stack Web Development",
      description: "Creating premium, sleek, and highly interactive frontend interfaces using Vue.js and Angular that communicate flawlessly with complex core platforms.",
      icon: "code"
    },
    {
      title: "DevOps, Cloud & Server Setup",
      description: "Configuring Ubuntu servers, domain routing, cPanel, Docker/K8s container orchestration, and automated CI/CD pipelines on AWS and GitHub Actions.",
      icon: "cloud"
    },
    {
      title: "Database Optimization",
      description: "Writing complex procedural SQL, tuning query performance, and designing producer/consumer patterns in PostgreSQL and MySQL for high-throughput systems.",
      icon: "database"
    }
  ]
}
